...
const CYBLE_BASS_T cyBle_bass[0x01u] = {
    {
        0x002Au, /* Handle of the BAS service */ 
        0x002Cu, /* Handle of the Battery Level characteristic */ 
        0x002Du, /* Handle of the Characteristic Presentation Format descriptor */ 
