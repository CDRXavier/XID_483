...
#define Buttons_5			(Buttons__5__PC)
#define Buttons_5_PS		(Buttons__5__PS)
#define Buttons_5_PC		(Buttons__5__PC)
#define Buttons_5_DR		(Buttons__5__DR)
#define Buttons_5_SHIFT	(Buttons__5__SHIFT)
#define Buttons_5_INTR	((uint16)((uint16)0x0003u << (Buttons__5__SHIFT*2u)))

#define Buttons_INTR_ALL	 ((uint16)(Buttons_0_INTR| Buttons_1_INTR| Buttons_2_INTR| Buttons_3_INTR| Buttons_4_INTR| Buttons_5_INTR))
