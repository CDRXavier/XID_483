...
#define SIM_BATTERY_MIN             (20u)        /* Minimum simulated battery level measurement */
#define SIM_BATTERY_MAX             (80u)       /* Maximum simulated battery level measurement */
#define SIM_BATTERY_INCREMENT       (5u)        /* Value by which the battery level is incremented */                             
